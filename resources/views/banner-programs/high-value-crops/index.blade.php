<x-app-layout>
	...
	<div class="text-center">
		<h1>
			<span class="badge bg-success">High Value Crop Program</span>
		</h1>

	</div>

	<a href="{{ route('high-value-crops.create') }}" class="btn btn-primary">Add Farmer to Program</a>
		...
		<div class="col-lg-12">
			...
			<div class="card">
				<div class="card-body table-wrapper table-responsive">
					...
					<table class="table table-hover" id="high-value-crop-table">
						<thead>
							<tr>
								<th>Farmer's Name</th>
								<th>Barangay</th>
	...
	<x-modal modal-id="high-value-crop-modal" button-id="destroy-high-value-crop" type="delete" label="High Value Crop"/>

	@push('scripts')
		<script src="{{ asset('js/page/high-value-crop/index.js') }}"></script>
	@endpush
</x-app-layout>
