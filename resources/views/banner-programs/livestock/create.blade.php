				...
				<div class="card">
					<div class="card-body">
						...
						<form class="row g-3" method="POST" action="{{ route('livestocks.store') }}">
							...
							<div class="col-md-12">
								<div class="form-floating mb-3">
									<select class="form-select" id="livestock_species" aria-label="livestock_species" name="livestock_species" required>
										...
										<option value="{{ $livestock_species }}">
											{{ $livestock_species }}
										</option>
										@endforeach
									</select>
									@error('livestock_species')
									<x-input-error message="{{ $message }}" />
									@enderror
							...
							<div class="col-md-12">
								<div class="form-floating mb-3">
									<input type="number" class="form-control @error('livestock_number') is-invalid @enderror" id="livestock_number" name="livestock_number" min="1" placeholder="Livestock Number">
									<label for="floatingTextarea">Livestock Number</label>
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-floating mb-3">
									<input type="number" class="form-control @error('age') is-invalid @enderror" id="age" name="age" placeholder="Livestock Age" min="0">
