				...
				<div class="card">
					<div class="card-body">
						...
						<form class="row g-3" method="POST" action="{{ route('corns.store') }}">
							...
							<div class="col-md-12">
								<div class="form-floating mb-3">
									<select class="form-control @error('corn_type') is-invalid @enderror" id="corn_type"
										name="corn_type" aria-label="Farmer Barangays" data-live-search="true" title="Choose Corn Type" required>
										@foreach (config('constants.corn_types') as $corn_type)
										<option value="{{ $corn_type }}">
											{{ $corn_type }}
										</option>
										@endforeach
									</select>
							...
							<div class="col-md-12">
								<div class="form-floating mb-3">
									<input type="number" class="form-control @error('hectares_field') is-invalid @enderror" id="hectares_field" name="hectares_field" placeholder="Hectares of Field" min="1">
